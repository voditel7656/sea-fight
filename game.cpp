...
enum Color { Black, Blue, Green, Cyan, Red, Magenta, Brown, 
	LightGray, DarkGray, LightBlue = 9, LightGreen, LightCyan, LightRed, LightMagenta, Yellow, White };
...
void Avake() //функция которая будет показана игроку самая первая
{
	...
	SetCursor(53, 15); //устанавливаем позицию курсора (на своё усмотренние)
